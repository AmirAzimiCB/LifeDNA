  ...
  return (
    <>
      <Card
        variant="default"
        className={cn(
          "w-full relative flex flex-col justify-between p-0 m-0 transition-all duration-500 ease-in-out border-[1.5px]",
          isExpanded ? "h-fit" : "h-fit min-h-[480px]",
          first && "border-[#41c752]  overflow-hidden ",
          second && "border-[#00a084]  overflow-hidden ",
          third && "border-[#07606e] rounded-tl-none rounded-tr-none"
        )}
      >
        {card.popular ? (
          <div className="flex items-center justify-center gap-2 p-5 text-white bg-[#07606e] absolute -top-14 -left-[1px] -right-[1px] rounded-tl-xl rounded-tr-xl border-[1.5px] border-[#07606e]">
            <svg
